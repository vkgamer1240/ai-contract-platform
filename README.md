...
|-------|-------------|---------|
| **🌐 Frontend** | ![React](https://img.shields.io/badge/React-18.3-61DAFB?logo=react) ![TypeScript](https://img.shields.io/badge/TypeScript-5.5-3178C6?logo=typescript) ![Vite](https://img.shields.io/badge/Vite-6.3-646CFF?logo=vite) | Modern, responsive user interface |
| **🎨 Styling** | ![Tailwind](https://img.shields.io/badge/Tailwind-3.4-06B6D4?logo=tailwindcss) ![Three.js](https://img.shields.io/badge/Three.js-0.161-000000?logo=three.js) | Professional design & 3D graphics |
| **⚙️ Backend** | ![Flask](https://img.shields.io/badge/Flask-2.0+-000000?logo=flask) ![Python](https://img.shields.io/badge/Python-3.8+-3776AB?logo=python) | RESTful API server |
| **🧠 AI/ML** | ![PyTorch](https://img.shields.io/badge/PyTorch-1.9+-EE4C2C?logo=pytorch) ![Transformers](https://img.shields.io/badge/🤗%20Transformers-4.4+-FFD21E) | Fine-tuned RoBERTa models |
| **🗄️ Database** | ![Supabase](https://img.shields.io/badge/Supabase-PostgreSQL-3ECF8E?logo=supabase) | User management & data storage |
| **🚀 Deployment** | ![Vercel](https://img.shields.io/badge/Vercel-Frontend-000000?logo=vercel) ![Railway](https://img.shields.io/badge/Railway-Backend-0B0D0E?logo=railway) | Production hosting |
...
[![GitHub Stars](https://img.shields.io/github/stars/vkgamer1240/ai-contract-platform?style=social)](https://github.com/vkgamer1240/ai-contract-platform)
[![GitHub Forks](https://img.shields.io/github/forks/vkgamer1240/ai-contract-platform?style=social)](https://github.com/vkgamer1240/ai-contract-platform/fork)
...
graph TB
    subgraph "Frontend Layer"
        ...
        A --> C[Tailwind CSS]
        A --> D[Three.js 3D Graphics]
    end
    
    subgraph "Backend Layer"
        E[Flask Server] --> F[CORS Handler]
        E --> G[API Routes]
        E --> H[Template Engine]
    end
    
    subgraph "AI/ML Layer"
        I[Fine-tuned RoBERTa] --> J[Contract Analyzer]
        K[Groq API] --> J
        J --> L[Risk Scorer]
    ...
    subgraph "Data Layer"
        N[Supabase PostgreSQL] --> O[User Management]
        N --> P[Contract Storage]
    end
...
|:------------:|:------------------:|
| ![Platform Landing Page](./image1.jpg) | ![Contract Analysis Interface](./image2.jpg) |
...
|:-------------------:|:-----------------:|
| ![Analysis Results Display](./image3.jpg) | ![Advanced Features Interface](./image4.jpg) |
